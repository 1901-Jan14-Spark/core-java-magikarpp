...
public class EvaluationService {
	...
	public int getScrabbleScore(String string) {
		HashMap<String, Integer> scoreMap = new HashMap<String, Integer>() {{
			put("A", 1); put("E", 1); put("I", 1); put("O", 1); put("U", 1); put("L", 1); put("N", 1); put("R", 1); put("S", 1); put("T", 1);
			put("D", 2); put("G", 2);
	...
	public String cleanPhoneNumber(String string) {
	    ...
	    // Int value of Character 1 == 49
	    if(Integer.valueOf(str.charAt(0)) == 49){
	      str = str.substring(1);
	    }
	
	    // Add/cut length of phone number
	    if(str.length() > 10){
	    	throw new IllegalArgumentException("Yo phone number is too big ma pep");
	    }
	    if(str.length() < 9){
	    	throw new IllegalArgumentException("Yo yo phone numba too small homedawg");
	    }
		return str;
	}
